...
if (isset($_POST['daftar'])) {
    ...
    $sql = "INSERT INTO rb_psb_pendaftaran_new (
            ...
            pendidikan_ibu, pekerjaan_ibu, penghasilan_ibu, no_hp_ibu, alamat_ibu, update_date, update_id, kartu_keluarga, photo_santri, img_siswa_1, img_siswa_2, img_siswa_3, img_siswa_4
        ) VALUES (
            ...
            '$update_date', '$update_id', '$kartu_keluarga', '$photo_santri', '$img_siswa_1', '$img_siswa_2', '$img_siswa_3', '$img_siswa_4'
        )";
               
               $psb = "INSERT INTO rb_psb_aktivasi (
                id_aktivasi,kode_pendaftaran,nama_lengkap,status,status_pendaftaran,status_data,status_ujian,status_medical_checkup,status_daftar_ulang,proses,waktu_input
            ) VALUES (
                NULL,'$nomor_baru', '$nama_lengkap', '0', '0', '0', '0', '0', '0', '0', '$update_date'
            )";
$result = mysql_query($psb);
        if (mysql_query($sql)) {
            echo "<script>document.location='index.php?view=psb-data';</script>";
            exit();
           // echo "<script>document.location='test_xendit.php';</script>"; // Redirect jika berhasil
        } else {
